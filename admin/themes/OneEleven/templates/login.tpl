...
<html>
    <head>
        ...
        <title>{'logintitle'|lang} - {if $sitename}{$sitename}{else}{sitename}{/if}</title>
        <base href="{$config.admin_url}/" />
        <meta name="generator" content="Copyright (C) 2004-19 {$config.web_company|default:'Lee Peace'}. All rights reserved." />
        ...
        <div id="wrapper">
            <div class="login-container">
                <div class="login-box cf"{if isset($error)} id="error"{/if}>
                    <div class="logo">
                        <img src="{$src.path}" alt="{$src.title}" />
                    </div>
