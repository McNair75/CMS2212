<?php
   ...
   $smarty->assign('MOD_ERROR_LOGGER_INFO',           $MOD_ERROR_LOGGER_INFO);
   $smarty->assign('MOD_ERROR_LOGGER_WARNING',        $MOD_ERROR_LOGGER_WARNING);
   $smarty->assign('MOD_ERROR_LOGGER_ERROR',          $MOD_ERROR_LOGGER_ERROR);
   $smarty->assign('MOD_ERROR_LOGGER_EXCEPTION',      $MOD_ERROR_LOGGER_EXCEPTION);
   $smarty->assign('MOD_ERROR_LOGGER_ITEMS_PER_PAGE', $MOD_ERROR_LOGGER_ITEMS_PER_PAGE);
