<?php
   ...
   $this->smarty = $this->GetActionTemplateObject();
   $strSort = "";
   ...
   if (isset($_POST['filter'])) {
      foreach((array)$_POST['filter'] as $strField => $strValue) {
         ...
         $strFilter .= " AND ".$strField." LIKE '%".$strValue."%'";
      }
   ...
   echo '<hr />'.
        '<a href="'.$this->CreateLink($id, 'dump', $returnid, '', [], '', true).'">Download CSV</a>' .
        ' | '.
