{strip}
    ...
    <div id="page_content">
        ...
        {if LISESmarty::LI2_present()}  
            <div id="importing_c">  
                <div class="pagewarning">{$mod->ModLang('importing_warning')}</div>
                <fieldset>
                    <legend>{$mod->ModLang('importing_from_li2')}</legend>
                    {$mod->ModLang('help_importing_from_li2')}
                </fieldset>
            </div>
        {/if}
        <div id="smarty_plugins_c">
            <fieldset>
                <legend>{literal}{LISELoader}{/literal}</legend>
        ...
        <div id="whatsnew_c">
            <div class="pageoverflow">
                ...
                <ul>
                    <li>
                        Search parameters are now stored into the session so they can be retrieved by smarty in your search form templates if needed using <strong>{ldelim}$&lt<em>instancename</em>&gt;_search}</strong> and <strong>{ldelim}$&lt;<em>instancename</em>&gt;_search_*}</strong>, where <strong>*</strong> is a field alias;</li>
                    <li>Added <strong>"filterorderby"</strong> parameter on action search when using filters: these allow you to order the dropdown or multiselect fields values on the search form template;</li>
                    <li>Added a custom field for core <strong>"File Picker"</strong>: LISE now supports the core new File Picker;</li>
                ...
                </ul>      <p>There are also bug fixes and some stability enhancements including a minor fix to make LISE compatible with CMSMS 2.2.2.</p>
            </div>  
        </div>
        <div id="about_c">
            <div class="pageoverflow">
                ...
                <p>Origin of this module comes from <strong>ListIt Module</strong> developed by <strong>Ben Malen</strong>.<br />As there were no plans on further development of the module some people decided to fork the module and continue with development.<br />
                    This is a third generation fork of the module and there are others. Consider this as another flavour of the original module.</p>
                ...
                <p>If you find any bugs please feel free to submit a bug report <a href="http://dev.cmsmadesimple.org/bug/list/1345" target="_blank">here</a> or for any good ideas consider submitting a feature request <a href="http://dev.cmsmadesimple.org/feature_request/list/1345" target="_blank">here</a>.</p>
