...
<fieldset>
    ...
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_sortable')}</p>
        <p class="pageinput">{$input_sortable}</p>
    </div>
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_item_allow_sametitle')}</p>
        <p class="pageinput">{$input_item_sametitle}</p>
    </div>
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_category_allow_sametitle')}</p>
        <p class="pageinput">{$input_category_sametitle}</p>
    </div>
    <div class="pageoverflow">
...
<fieldset>
    <legend>{$mod->ModLang('maps')}</legend>
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_maps')}:</p>
        <p class="pageinput">{$input_maps}</p>
    </div> 	
</fieldset>

<fieldset>
    <legend>{$mod->ModLang('category')}</legend>
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_category_enabled_wysiwyg')}:</p>
        <p class="pageinput">{$input_category_enabled_wysiwyg}</p>
    </div>
    <div class="pageoverflow">
        <p class="pagetext">{$mod->ModLang('prompt_category_noparent')}:</p>
        <p class="pageinput">{$input_category_noparent}</p>
    </div>
</fieldset>
