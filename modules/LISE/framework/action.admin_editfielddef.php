...
if (isset($fielddef_obj) && empty($template))
...
if (isset($params['submit']) || isset($params['apply']) || isset($params['save_create'])) {
    ...
    if (!lise_utils::is_valid_alias($alias) && !empty($alias)) {
        ...
        if (
                isset($fielddef_id) && !empty($alias) && $alias != $fielddef_obj->GetAlias() && LISEFielddefOperations::Load($this, 'alias', $alias) != false && $exists
        ) {
