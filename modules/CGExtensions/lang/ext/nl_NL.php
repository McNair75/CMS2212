...
$lang['add_lkp_entry'] = 'Voeg item toe';
...
$lang['allowed_upload_filetypes'] = 'Bestandextensies die mogen worden geüpload';
...
$lang['CGFILEUPLOAD_FILETYPE'] = 'Dit bestandstype kan niet worden geüpload';
...
$lang['CGFILEUPLOAD_PREPROCESSING_FAILED'] = 'Het voorbereiden van het geüploade bestand is mislukt';
$lang['countries'] = 'Landen';
$lang['default_templates'] = 'Standaard sjablonen';
$lang['del_lkpitem'] = 'Verwijder nazoek item';
$lang['description'] = 'Beschrijving';
$lang['down'] = 'Omlaag';
$lang['edit'] = 'Bewerk';
$lang['edit_lkpitem'] = 'Bewerk nazoek item';
$lang['error'] = 'Fout!';
$lang['error_image_transform'] = 'Fout bij de bewerking van de afbeelding';
$lang['error_itemnotfound'] = 'Het gespecificeerde item kon niet worden gevonden';
$lang['error_missingparam'] = 'Een noodzakelijke parameter ontbreekt of is ongeldig';
$lang['error_lkp_namerequired'] = 'Een naam is verplicht voor dit nazoek item';
...
$lang['err_modulenotfound'] = 'Module exemplaar %s kon niet worden gevonden';
$lang['err_vrfy_c1filebad'] = 'Het _c1.dat bestand voor de gebruikte module is onjuist of incompleet.';
$lang['err_vrfy_extrafiles'] = 'Er staan bestanden in de module folder die nooit bij deze module zijn gedistribueerd. Dit heeft een effect op de digitale handtekening';
$lang['err_vrfy_failed'] = 'Module validatie mislukt. Het lijkt erop dat er één of meer bestanden aangepast zijn na distributie';
$lang['err_vrfy_filenotfound'] = 'Probleem met lezen %s. Of het bestaat niet of er is een bevoegdheid probleem.';
$lang['err_vrfy_nochecksumdata'] = 'Kan de gegevensintegriteit van %s niet verifiëren. Er is geen checksum';
$lang['err_vrfy_nofiledata'] = 'Problem met het verifiëren van de module. Er is geen data beschikbaar.';
$lang['err_vrfy_rootpath'] = 'Probleem met het lezen van %s. Het lijkt niet te bestaan in de module folder, maar wel ergens anders.';
$lang['err_vrfy_dirwritable'] = 'De folder %s is niet schrijfbaar. Kan geen checksum bestand aanmaken';
$lang['err_vrfy_filewritable'] = 'Het bestand %s is niet schrijfbaar. Kan geen checksum bestaan aanmaken';
...
$lang['generate_module_checksums'] = 'Genereer Module Checksums';
$lang['go'] = 'Ga';
$lang['graphics_settings'] = 'Grafische instellingen';
$lang['graphic_watermarks'] = 'Grafische watermerken';
$lang['group'] = 'Groep';
$lang['has_checksum_data'] = 'Heeft Checksums';
$lang['help'] = 'Hulp';
$lang['id'] = 'Id';
$lang['image'] = 'Afbeelding';
$lang['image_extensions'] = 'Afbeeldingsbestandextensies';
$lang['info_allowed_upload_filetypes'] = 'Benoem een komma gescheiden lijst van extensies die mogen worden geüpload.  <strong>Opmerking:</strong> Modules die gebruik maken van CGExtensions upload functionaliteiten kunnen deze instellingen overschrijven';
...
$lang['info_countries_tab'] = 'Voer één regel in per land, met de landcode en landnaam gescheiden door = <em>(bijv. NL=Nederland)</em>. Lege regels en extra witruimte worden genegeerd.';
...
$lang['info_states_tab'] = 'Voer één regel per staat/provincie in, met de provincie code en naam gescheiden door = <em>(bijv.: ZH=Zuid-Holland)</em>. Lege regels en extra witruimte worden genegeerd.';
...
$lang['msg_templatesaved'] = 'Sjabloon opgeslagen';
$lang['msg_vrfy_checksumgenerated'] = 'Checksum informatie voor %s gegenereerd';
$lang['msg_vrfy_integrityverified'] = 'Module slaagt voor de checksum test';
$lang['name'] = 'Naam';
$lang['no'] = 'Nee';
$lang['none'] = 'Geen';
...
$lang['prompt_allow_resizing'] = 'Verschaal geüploade afbeeldingen?';
$lang['prompt_allow_thumbnailing'] = 'Maak miniaturen van geüploade afbeeldingen?';
$lang['prompt_allow_watermarking'] = 'Voorzie geüploade afbeeldingen van een watermerk?';
