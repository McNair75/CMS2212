...
final class cge_userops
{
     ...
     * @return array
     */
    public static function get_grouplist(bool $inclnone = TRUE)
    {
        static $list;
        if( !is_array($list) ) {
     ...
     * @return int|null
     */
    public static function get_groupid(string $groupname)
    {
     ...
     * @return int[]
     */
    public static function get_group_members(int $groupid, bool $all = false)
    {
        if( $groupid < 1 ) return;
     ...
     * @return string[]
     */
    public static function expand_group_emails(int $groupid)
    {
        if( $groupid <= 0 ) return;
     ...
     *
     * @param int|int[] $list The list of CMSMS admin UIDs
     * @return string[]
     */
     ...
     * @return string
     */
    static public function get_uid_email(int $uid = null)
    {
        $uid = (int)$uid;
     ...
     */
    static public function get_admin_membergroups(int $uid)
    {
        $uid = (int) $uid;
        if( $uid < 1 ) return;
