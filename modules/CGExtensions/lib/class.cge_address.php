...
class cge_address implements \JsonSerializable
{
     ...
     * @param string $str
     */
    public function set_company(string $str)
    {
        $this->company = $str;
    }
     ...
     * @param string $str
     */
    public function set_firstname(string $str)
    {
        $this->firstname = $str;
    }
     ...
     * @param string $str
     */
    public function set_lastname(string $str)
    {
        $this->lastname = $str;
    }
     ...
     * @param string $str
     */
    public function set_address1(string $str)
    {
        $this->address1 = $str;
    }
     ...
     * @param string $str
     */
    public function set_address2(string $str)
    {
        $this->address2 = $str;
    }
     ...
     * @param string $str
     */
    public function set_city(string $str)
    {
        $this->city = $str;
    }
     ...
     * @param string $str
     */
    public function set_state(string $str)
    {
        $this->state = $str;
    }
     ...
     * @param string $str
     */
    public function set_postal(string $str)
    {
        $this->postal = $str;
    }
     ...
     * @param string $str
     */
    public function set_country(string $str)
    {
        $this->country = $str;
    }
     ...
     * @param string $str
     */
    public function set_phone(string $str)
    {
        $this->phone = $str;
    }
     ...
     * @param string $str
     */
    public function set_fax(string $str)
    {
        $this->fax = $str;
    }
     ...
     */
    public function from_array(array $params,string $prefix = '')
    {
     ...
     * @return array
     */
    public function to_array(string $prefix = '')
    {
        $result = array();
