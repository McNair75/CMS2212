...
final class cge_array
{
     ...
     * @return array
     */
    static public function insert_unique(array $arr,$val)
    {
     ...
     * @return bool
     */
    static public function key_exists_substr(array $arr,string $expr)
    {
        $keys = array_keys( $arr );
        foreach( $keys as $k ) {
     ...
     */
    static public function find_key_regexp(array $arr,string $expr)
    {
        $keys = array_keys( $arr );
        foreach( $keys as $k ) {
     ...
     */
    static public function merge_by_keys(array $arr1,array $arr2,string $key1 = 'name',string $key2 = 'name')
    {
     ...
     * @return array
     */
    static public function to_hash(array $input,string $key)
    {
        $tmp = array();
        if( is_array($input) ) {
     ...
     * @return array
     */
    public static function extract_field(array $input,string $key)
    {
     ...
     * @return int -1, 0, or -1
     */
    static public function compare_elements_by_sortorder_key(array $e1,array $e2,string $key = 'sort_key')
    {
        if( $e1[$key] < $e2[$key] ) {
            return -1;
        }
     ...
     * @return bool
     **/
    static public function hashsort(array &$input,string $key,bool $is_string = false,bool $casecompare = false)
    {
     ...
     * @return bool
     **/
    static public function objsort(array &$input,string $member,bool $is_string = false,bool $casecompare = false)
    {
     ...
     * @return void
     */
    static public function hashrsort(array &$input,string $key,bool $is_string = false,bool $casecompare = false)
    {
     ...
     * @return array
     */
    static public function explode_with_key(string $str, string $inglue='=', string $outglue='&')
    {
        $ret = array();
     ...
     */
    function find_index(array $data, $needle)
    {
     ...
     * @returns string;
     */
    static public function implode_with_key(array $assoc, string $inglue = '=', string $outglue = '&')
    {
        $return = null;
     ...
     * @return string
     */
    static public function implode_quoted(array $data,string $glue = ',',string $quote = '"')
    {
        $return = '';
     ...
     */
    static public function to_object(array $array,bool $recursive = FALSE)
    {
        $obj = new \StdClass();
     ...
     * @return hash
     */
    static public function hash_prepend(array $input,string $key,$value)
    {
        $tmp = array();
        $tmp[$key] = $value;
        if( is_array($input) ) {
     ...
     * @return array
     */
    static public function remove_by_value(array $input,string $value = '')
    {
        $tmp = array();
     ...
     * @return bool
     */
    static public function is_hash(array $arr) : bool
    {
     ...
     */
    static public function explode_to_tree(array $hash, string $delimiter = '.', bool $baseval = false)
    {
     ...
     * @return array
     */
    public static function smart_explode(string $str,string $delim = ',',string $safe_char = '"')
    {
        $out = array();
        $col = '';
        $is_safe = 0;
     ...
     */
    public function search_recursive(array $input,string $needle)
    {
        foreach( $input as $key => $value ) {
