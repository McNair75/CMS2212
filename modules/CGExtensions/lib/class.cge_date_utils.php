...
final class cge_date_utils
{
     ...
     */
    public static function date_from_form(array $params,string $prefix,string $prefix2 = null)
    {
     ...
     * @return int
     */
    static public function ts_set_time(int $timestamp,int $hour,int $minutes) : int
    {
     ...
     * @deprecated
     */
    static public function ts_set_time_from_str(int $timestamp,string $str) : int
    {
        $obj = new cge_date($timestamp);
     ...
     * @return bool
     */
    static public function is_leapyear(int $year = null) : bool
    {
        if( !$year ) $year = date('Y');
     ...
     * @return int
     */
    static public function days_in_month(int $month = null,int $year = null) : int
    {
     ...
     * @return cge_date
     */
    static public function date_at(int $month,int $day,int $year,int $hour = 0,int $minute = 0,int $seconds = 0) : cge_date
    {
     ...
     * @return string
     */
    static public function ts_to_dbformat(int $ts) : string
    {
        if( $ts < 1 ) return '';
     ...
     */
    static public function from_locale_str(string $str) : int
    {
     ...
     * @return string
     */
    static public function to_locale_str(int $ts,bool $time_too = TRUE,string $sep = '/') : string
    {
        $lang = CmsNlsOperations::get_current_language();
        $fmt = "%d{$sep}%m{$sep}%Y";
        if( $lang == 'en_US' ) {
     ...
     * @return string
     */
    static public function rfc_date(int $ts) : string
    {
        $fmt = '%Y-%m-%dT%H:%M:%S';
        $tmp = strftime($fmt,$ts);
        $tmp .= date('P');
