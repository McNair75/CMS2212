...
final class cge_string
{
     ...
     * @return string
     */
    public static function mask_string(string $instr,int $numchars,string $mask = '*')
    {
     ...
     * @return string
     */
    public static function word_limiter(string $str, int $limit = 100, string $end_char = '...')
    {
     ...
     * @return int
     */
    public static function str_to_bytes(string $val)
    {
        if(is_string($val) && $val != '') {
            $val = trim($val);
            $ival = (int) $val;
            $last = strtolower(substr($val, strlen($ival), 1));
            switch($last) {
            case 'g':
                $ival *= 1024;
            case 'm':
     ...
     * @return bool
     */
    public static function is_smarty_safe(string $string)
    {
     ...
     * @return float
     */
    public static function to_float(string $in)
    {
     ...
     * @return string
     */
    public static function to_string(float $in)
    {
