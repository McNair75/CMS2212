...
$lang['search_method'] = 'Compatibilité via la méthode POST des Pretty URLs, la valeur par défaut est toujours la méthode GET, pour utiliser cette recherche mettre (Search search_method = "post")';
